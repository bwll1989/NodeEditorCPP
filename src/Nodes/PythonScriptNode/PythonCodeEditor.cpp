...
PythonCodeEditor::PythonCodeEditor(QString code,QWidget* parent):
        m_code(code),
...
QString PythonCodeEditor::loadCode(QString path)
{
    QFile fl(path);
...
void PythonCodeEditor::loadCodeFromCode(QString val) {
...
// 在createWidgets()方法中修改语法高亮
void PythonCodeEditor::createWidgets()
{
    ...
    // 使用Python语法高亮
    QsciLexerPython* pythonLexer = new QsciLexerPython(this);
    m_codeEditor->setLexer(pythonLexer);
...
void PythonCodeEditor::setupWidgets()
{
...
QString PythonCodeEditor::saveCode() {
...
void PythonCodeEditor::performConnections()
{
    ...
    connect(exportJS,&QPushButton::clicked,this,&PythonCodeEditor::exportCode);
}
void PythonCodeEditor::setReadOnly(bool readOnly)
{
 ...
 */
void PythonCodeEditor::exportCode()
{
    // 创建插件元数据收集对话框
