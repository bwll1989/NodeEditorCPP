...
namespace Nodes
{
class ToImageFileInterface : public QWidget
{
    Q_OBJECT

public:
    explicit ToImageFileInterface(QWidget* parent = nullptr)
        : QWidget(parent)
    {
        ...
        _fileEdit->setText(QStringLiteral("capture.png"));
        ...
        connect(_recordToggle, &QPushButton::toggled, this, &ToImageFileInterface::onRecordToggled);
        connect(_fileEdit, &QLineEdit::textChanged, this, &ToImageFileInterface::fileTextChanged);
        connect(_folderButton, &QPushButton::clicked, this, &ToImageFileInterface::onSelectFolder);
