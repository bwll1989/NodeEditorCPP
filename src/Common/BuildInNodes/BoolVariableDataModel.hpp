...
namespace Nodes {
    class BoolVariableDataModel : public AbstractDelegateModel
    {
        Q_OBJECT
    ...
    public:
        ...
        BoolVariableDataModel(): button(new QPushButton("Toggle")){
            InPortCount =1;
            OutPortCount=1;
            CaptionVisible=true;
            Caption="Bool Variable";
            ...
            // 用户点击直接驱动属性 setValue
            connect(button, &QPushButton::clicked, this, &BoolVariableDataModel::setValue);
            // 属性变化统一更新界面并发送反馈、通知输出端口
            connect(this, &BoolVariableDataModel::valueChanged, this, [this](bool){
                // 1. 界面状态和属性自动对齐
