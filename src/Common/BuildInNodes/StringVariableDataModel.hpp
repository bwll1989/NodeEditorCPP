...
namespace Nodes {
    class TextVariableDataModel : public AbstractDelegateModel
    {
        Q_OBJECT
    ...
    public:
        ...
        TextVariableDataModel():_lineEdit(new QLineEdit("")){
            InPortCount =1;
            OutPortCount=1;
            CaptionVisible=true;
            ...
            connect(_lineEdit, &QLineEdit::textChanged, this, &TextVariableDataModel::onTextEdited);
            connect(this, &TextVariableDataModel::valueChanged, this, [this](const QString &){
