...
namespace Nodes {
    class ToggleVariableDataModel : public AbstractDelegateModel
    {
        Q_OBJECT
    ...
    public:
        ...
        ToggleVariableDataModel(): button(new QPushButton("Toggle")){
            InPortCount =1;
            OutPortCount=1;
            CaptionVisible=true;
            Caption="Toggle Variable";
            ...
            // 用户点击直接驱动属性 setValue
            connect(button, &QPushButton::clicked, this, &ToggleVariableDataModel::setValue);
            // 属性变化统一更新界面并发送反馈、通知输出端口
            connect(this, &ToggleVariableDataModel::valueChanged, this, [this](bool){
                // 1. 界面状态和属性自动对齐
