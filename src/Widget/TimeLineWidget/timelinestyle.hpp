...
//
#include "QColor"
#ifndef TIMELINESTYLE_HPP
#define TIMELINESTYLE_HPP
...
inline QColor bgColour = QColor(40, 40, 40);  // 深灰色背景
...
inline QColor trackColour = QColor("#262626"); //轨道颜色

inline QColor trackSelectedColour = trackColour.lighter(180); //轨道选中颜色

inline QColor trackHoverColour = trackColour.lighter(80); //轨道悬停颜色
