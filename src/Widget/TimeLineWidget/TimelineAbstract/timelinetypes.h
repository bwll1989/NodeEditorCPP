...
//         // Drop Frame 时间码的特殊处理
//         if (frameRate == TimecodeFormat::NTSC_DF || frameRate == TimecodeFormat::PAL_DF) {
//             // Drop Frame 计算逻辑
...
//             case TimecodeType::Film_DF:  return TimecodeFormat::FILM_DF;
...
//             case TimecodeType::PAL_DF:   return TimecodeFormat::PAL_DF;
//             default:                     return 0.0;
//         }
//     }
//     // 转换为总帧数
